...
const AuthService = {
  ...
  updateProfile: async (accessToken, data) => {
    try {
      const response = await axios.patch(`${API_URL}/update-account`, data, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
  ...
  updateAvatar: async (accessToken, data) => {
    try {
      const response = await axios.patch(`${API_URL}/avatar`, data, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "multipart/form-data",
        },
  ...
  updateCoverImage: async (accessToken, data) => {
    try {
      const response = await axios.patch(`${API_URL}/cover-image`, data, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "multipart/form-data",
        },
